...
namespace GestionImpresoras.Controllers
{
    public class EstadoSolicitudesController : Controller
    {
        ...
        public EstadoSolicitudesController(ApplicationDBContext contexto)
        {
        ...
        {
            var listado = await _contexto.EstadoSolicitudes.ToListAsync();
            return View(listado);
        }
        ...
        public async Task<IActionResult> Crear(EstadoSolicitud estadoSolicitud)
        {
            if (ModelState.IsValid)
            {
                _contexto.EstadoSolicitudes.Add(estadoSolicitud);
